                ...
                <div class="accordion" id="faqAccordion">
                    ...
                    $faqs = $isGu ? [
                        ...
                        ['q' => 'ટ્રસ્ટની સેવાઓ કોના માટે છે?',
                         'a' => 'અમારી વિનામૂલ્યે ટિફિન સેવા ૬૦ વર્ષ અને તેથી વધુ ઉંમરના એકલા રહેતા વૃદ્ધ અને અપંગ વ્યક્તિઓ માટે ઉપલબ્ધ છે, જેઓ પોતાના માટે રસોઈ બનાવી શકતા નથી — નારણપુરા, ગોતા, ચાંદલોડિયા, નિર્ણયનગર, નવા વાડજ અને રાણીપ વિસ્તારોમાં.'],
                        ...
                        ['q' => 'Who can benefit from the trust\'s meal service?',
                         'a' => 'Our free tiffin service is available to elderly (60+) and disabled individuals from middle-income backgrounds who live alone and cannot cook for themselves in Naranpura, Gota, Chandlodiya, Nirnaynagar, Nava Vadaj, and Ranip areas of Ahmedabad.'],
