...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12 col-md-6 col-lg-3 mb-2">
            <div class="card ">
                <div class="card-body">
                    <form action="{{ route('admin.monthly-report.donation') }}" method="GET">
                        <div class="mb-3">
                            <label>{{ trans('messages.donation') }}</label>
                            <select name="month_year" class="form-control form-select">
                                @foreach ($donationMonths as $month)
                        ...
                        <div class="col-6">
                            <input type="submit" class="btn btn-primary w-100" value="{{ trans('portal.export') }}">
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="col-sm-12 col-md-6 col-lg-3 mb-2">
            <div class="card ">
                <div class="card-body">
                    <form action="{{ route('admin.monthly-report.labharthi') }}" method="GET"
                        enctype="multipart/form-data">
                        <div class="mb-3">
                            <label>{{ trans('messages.labharthi') }}</label>
                            <select name="month_year" class="form-control form-select me-md-2">
                                @foreach ($labharthiMonths as $month)
                                    <option value="{{ $month->value }}"
                                        {{ $month->value == $selectedMonthYear ? 'selected' : '' }}>
                                        {{ $month->label }}
                                    </option>
         ...
         <div class="col-sm-12 col-md-6 col-lg-3 mb-2">
            <div class="card ">
                <div class="card-body">
                    <form action="{{ route('admin.monthly-report.attendance') }}" method="GET"
                        enctype="multipart/form-data">
                        <div class="mb-3">
                            <label>{{ trans('portal.attendance') }}</label>
                            <select name="month_year" class="form-control form-select me-md-2">
