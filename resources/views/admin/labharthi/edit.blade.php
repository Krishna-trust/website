    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn d-none d-xl-flex d-lg-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ @trans('portal.edit') }}
                        ...
                        <form action="{{ route('admin.labharthi.update', $labharthi->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="native_place" id="native_place"
                                            class="form-control @error('native_place') is-invalid @enderror"
                                            value="{{ old('native_place', $labharthi->native_place) }}">
                                        @error('native_place')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="sub_cast" id="sub_cast"
                                            class="form-control @error('sub_cast') is-invalid @enderror"
                                            value="{{ old('sub_cast', $labharthi->sub_cast) }}">
                                        @error('sub_cast')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="category" id="category"
                                            ...
                                            <option value="vidhva"
                                                {{ old('category', $labharthi->category) == 'vidhva' ? 'selected' : '' }}>
                                                {{ @trans('portal.vidhva') }}</option>
                                            <option value="vidhur"
                                                {{ old('category', $labharthi->category) == 'vidhur' ? 'selected' : '' }}>
                                                {{ @trans('portal.vidhur') }}</option>
                                            <option value="rejected"
                                                {{ old('category', $labharthi->category) == 'rejected' ? 'selected' : '' }}>
                                                {{ @trans('portal.rejected') }}</option>
                                            <option value="other"
                                                {{ old('category', $labharthi->category) == 'other' ? 'selected' : '' }}>
                                                {{ @trans('portal.other') }}</option>
                                        </select>
                                        @error('category')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label
                                            for="identification_mark">{{ @trans('portal.identification_mark') }}</label>
                                        <input type="text" name="identification_mark" id="identification_mark"
                                            ...
                                            value="{{ old('identification_mark', $labharthi->identification_mark) }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="income_source" id="income_source" class="form-control @error('income_source') is-invalid @enderror"
                                            rows="2">{{ old('income_source', $labharthi->income_source) }}</textarea>
                                        @error('income_source')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="property" id="property" class="form-control @error('property') is-invalid @enderror"
                                            rows="2">{{ old('property', $labharthi->property) }}</textarea>
                                        @error('property')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group mb-3">
                                <label for="relative_info">{{ @trans('portal.relative_info') }}</label>
                                <textarea name="relative_info" id="relative_info" class="form-control @error('relative_info') is-invalid @enderror"
                                    rows="2">{{ old('relative_info', $labharthi->relative_info) }}</textarea>
                                @error('relative_info')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                <label
                                    for="reasion_for_not_working">{{ @trans('portal.reasion_for_not_working') }}</label>
                                <textarea name="reasion_for_not_working" id="reasion_for_not_working"
                                    class="form-control @error('reasion_for_not_working') is-invalid @enderror" rows="2">{{ old('reasion_for_not_working', $labharthi->reasion_for_not_working) }}</textarea>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="reasion_for_tifin" id="reasion_for_tifin"
                                    class="form-control @error('reasion_for_tifin') is-invalid @enderror" rows="2">{{ old('reasion_for_tifin', $labharthi->reasion_for_tifin) }}</textarea>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="comment_from_trust" id="comment_from_trust"
                                    class="form-control @error('comment_from_trust') is-invalid @enderror" rows="2">{{ old('comment_from_trust', $labharthi->comment_from_trust) }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label
                                            for="tifin_starting_date">{{ @trans('portal.tifin_starting_date') }}</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" name="tifin_ending_date" id="tifin_ending_date"
                                            class="form-control @error('tifin_ending_date') is-invalid @enderror"
                                            value="{{ isset($labharthi->tifin_ending_date) ? \Carbon\Carbon::parse($labharthi->tifin_ending_date)->format('Y-m-d') : old('tifin_ending_date') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label
                                            for="reasion_for_tifin_stop">{{ @trans('portal.reasion_for_tifin_stop') }}</label>
                                        <input type="text" name="reasion_for_tifin_stop" id="reasion_for_tifin_stop"
                                            class="form-control @error('reasion_for_tifin_stop') is-invalid @enderror"
                                            value="{{ old('reasion_for_tifin_stop', $labharthi->reasion_for_tifin_stop) }}">
