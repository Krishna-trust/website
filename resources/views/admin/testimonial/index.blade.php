...
<div class="page-header d-flex flex-wrap justify-content-between align-items-center my-0">
    <div>
        <h1 class="page-title">{{ @trans('messages.testimonials') }}</h1>
    </div>
    ...
    <div class="ms-auto pageheader-btn d-flex d-md-none mt-0">
        <a href="{{ route('admin.testimonial.create') }}" class="btn btn-secondary me-2">
        ...
        <div class="card overflow-hidden customers">
            <div class="p-4 card-body">
                ...
                <div class="mt-4 table-responsive">
                    @include('admin.testimonial.view')
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.user-delete-btn').click(function() {
            var DataId = $(this).data('testimonial-id');
            $('#testimonial_id').val(DataId);
